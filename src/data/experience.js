export const EXPERIENCES = [
  ...
  },
  {
    ...
    description: "Delivered end-user support by resolving hardware, software, and network issues while managing accounts and access permissions. Maintained documentation, tracked inventory, and met SLA targets to support smooth IT operations.",
    technologies: ["Active Directory", "Microsoft 365", "ServiceNow", "Microsoft Azure"],
  },
];